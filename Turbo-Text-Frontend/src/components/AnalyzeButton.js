  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow: disabled ? "none" : "0 4px 25px rgba(190, 18, 60, 0.4)",
      ...
      onMouseEnter={(e) => {
        if (!disabled && !loading) {
            ...
            e.target.style.boxShadow = "0 8px 35px rgba(190, 18, 60, 0.6)";
        }
      }}
      onMouseLeave={(e) => {
        if (!disabled && !loading) {
            e.target.style.transform = "translateY(0) scale(1)";
            e.target.style.boxShadow = "0 4px 25px rgba(190, 18, 60, 0.4)";
        }
      }}
    >
      {loading ? (
